...
for n in range (1,nrows):
    ...
    if 'XOA' in hostname:
        config_file = ('C:/Users/alawn/Desktop/Desktop/XOA.txt')
    elif 'EVP' in hostname:
        config_file = ('C:/Users/alawn/Desktop/Desktop/EVP.txt')
    elif 'EWL' in hostname:
        config_file = ('C:/Users/alawn/Desktop/Desktop/EWL.txt')
    new_file = ('C:\\Users\\alawn\\Desktop\\configuration-file\\config\\' + hostname + '.txt')
